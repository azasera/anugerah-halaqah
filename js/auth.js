        ...
        <div class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-teal/10 flex items-center justify-center p-4">
            <div class="max-w-md w-full">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="font-display font-extrabold text-3xl text-slate-900 mb-2">Anugerah Halaqah Qur'an</h1>
                    <p class="text-sm text-slate-600">Sistem Monitor Setoran Santri</p>
                </div>
